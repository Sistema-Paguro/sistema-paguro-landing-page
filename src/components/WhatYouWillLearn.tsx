                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                        {cards.map((card, index) => (
                            <div
                                key={index}
                                className="group relative bg-[#0a0a1a] rounded-3xl p-6 lg:p-8 border border-white/5 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-magenta/30 hover:shadow-[0_0_40px_rgba(192,28,131,0.15)]"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center justify-between mb-6">
                                        <div className="text-magenta font-bold text-4xl lg:text-5xl opacity-30 group-hover:opacity-100 transition-opacity duration-500">
                                            0{index + 1}
                                        </div>
                                        <div className="text-magenta/50 group-hover:text-magenta transition-colors duration-500">
                                            {(() => {
                                                const Icon = cardIcons[index];
                                                return Icon ? <Icon className="w-8 h-8 lg:w-10 lg:h-10" /> : null;
                                            })()}
                                        </div>
                                    </div>
