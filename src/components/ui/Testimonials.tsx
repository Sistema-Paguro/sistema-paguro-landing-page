        ...
        <section className="py-24 bg-[#050510] relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    {/* Left Column: Header / Social Proof */}
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-tight">
                            {t("testimonials.titleLine1")} <br className="hidden lg:block" />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-magenta to-blue">{t("testimonials.titleLine2")}</span>
                        </h2>

                        {/* Demo Component Integration */}
                        <div className="flex flex-wrap items-center justify-center lg:justify-start sm:divide-x divide-gray-700 bg-white/5 p-4 sm:px-6 rounded-2xl backdrop-blur-sm border border-white/10 gap-4 sm:gap-0">
                    ...
                    <div className="flex flex-wrap items-center justify-center lg:justify-end gap-6 relative z-10">
