    ...
    return (
        <section className="relative w-full min-h-[90vh] flex flex-col lg:flex-row items-center justify-between px-6 py-12 lg:px-16 lg:py-0 overflow-hidden bg-[#050510]">
            ...
            <div className="hidden lg:block absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-[#050510] via-[#050510]/60 via-40% to-transparent"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-[#050510] via-transparent to-[#050510]/30"></div>
            </div>
